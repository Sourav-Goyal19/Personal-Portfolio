                ...
                <div className="personal-information-container">
                    <div className="personal-information">
                        <div className="information">
                            ...
                            <h2 ref={firstNameRef} className={`my-name ${firstNameInView ? 'translate' : ''}`}>Sourav <a ref={lastNameRef} className={`slider ${lastNameInView ? 'lastNameAnimation' : ''}`}><span className={`last-name`}>Goyal</span></a></h2>
                            <div ref={smallAboutRef} className={`small-about ${smallAboutInView ? 'translate2' : ''}`} >
                                <h2>I'm a</h2>
                                <div>
                                    <h2>Programmer</h2>
                            ...
                            <p ref={bioRef} className={`bio ${bioInView ? 'translate3' : ''}`}>I'm a passionate and dedicated Frontend Developer with a strong focus on user experience. I'm currently focused on building responsive and accessible web applications. I'm also interested in learning new technologies and solving problems.</p>
                        </div>
                        <div ref={socialMediaRef} className={`social-media ${socialMediaInView ? 'translate4' : ''}`}>
                            <a className='social-media-link' onMouseLeave={() => removeNameFromCursor()} onMouseEnter={() => { addNameToCursor('Github') }} href="https://github.com/Sourav-Goyal19" target="_blank" rel="noopener noreferrer"><BsGithub /></a>
                            <a className='social-media-link' onMouseLeave={() => removeNameFromCursor()} onMouseEnter={() => { addNameToCursor('LinkedIn') }} href="https://www.linkedin.com/in/sourav-goyal-0555a51b4/" target="_blank"><AiFillLinkedin size={29} /></a>
                            <a className='social-media-link' onMouseLeave={() => removeNameFromCursor()} onMouseEnter={() => { addNameToCursor('Instagram') }} href="https://www.instagram.com/goyalsourav8893/" target="_blank" rel="noopener noreferrer"><BsInstagram size={24} /></a>
                        </div>
                    </div>
                    <a ref={resumeRef} target="_blank" rel="noopener noreferrer" download={true} className={`resume-btn ${resumeInView ? 'translate5' : ''}`} href="/assets/Resume.pdf">
