        ...
        <div className="aboutContainer">
          <div className="aboutDetails">
            ...
            <div data-aos="fade-right" className={`aboutText`}>
              <p>
                Hello! I'm Sourav Goyal, a passionate Frontend Developer with a
                strong foundation in HTML, CSS, JavaScript, and React JS. I
                thrive on transforming creative ideas into stunning,
                user-friendly web experiences. Currently pursuing my BCA, I am
                based in the vibrant city of New Delhi.{" "}
              </p>
            </div>
          </div>
          <div data-aos="fade-left" className={`aboutImage`}>
            <div
              ...
              className={`aboutPageRedirect ${
                arrowTransition ? "arrowTransition" : ""
