                        ...
                        return (
                            index % 2 == 0 ?
                                <div key={index} className="Experience-Content left-content sm:w-1/2 relative pt-3 sm:right-0 w-full">
                                    <div data-aos="fade-right" className="experience-card h-[200px] overflow-y-auto bg-slate-200 px-5 pt-5 rounded-2xl">
                             ...
                             ">{item.heading}</h3>
                                    ...
                                    <div data-aos="fade-right" className="experience-img absolute rounded-full bg-white z-20">
                                        {/* <img src={item.logo} className='w-full h-auto' alt="" /> */}
                                    </div>
                                ...
                                <div key={index} className="Experience-Content right-content sm:w-1/2 relative pt-3 sm:left-1/2 left-1 w-full">
                                    <div data-aos="fade-left" className="experience-card h-[200px] overflow-y-auto bg-slate-200 px-5 pt-5 rounded-2xl">
                                        <h3 className="experience-heading font-medium text-2xl mb-2">{item.heading}</h3>
                                        <p className="experience-time text-base mb-3 font-medium ">{item.duration}</p>
                                        <div className="experience-summary">{item.summary}</div>
                                    </div>
                                    <div className="experience-img absolute -left-3  rounded-full bg-white z-20">
                                    </div>
